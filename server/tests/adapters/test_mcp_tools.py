...
from brasil_mcp_match_server.adapters.mcp.server import build_server, build_stdio_context
from brasil_mcp_match_server.adapters.mcp.tools import RequestContext
...
async def test_mcp_error_payload_for_unknown_code() -> None:
    ...
    from brasil_mcp_match_server.adapters.mcp.tools import _error_payload
