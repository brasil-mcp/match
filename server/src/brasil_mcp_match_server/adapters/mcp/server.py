...
from brasil_mcp_match_server.adapters.mcp.tools import RequestContext, register_tools
...
def main() -> None:  # pragma: no cover - thin entry, exercised manually via stdio
    ...
    from brasil_mcp_match_server.core.ingestion.manifest import base_updated_date
    from brasil_mcp_match_server.core.repository.connection import connect, get_database_url
