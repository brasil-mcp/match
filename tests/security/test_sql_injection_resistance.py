...
from brasil_mcp_match.core.audit import log as audit_mod
from brasil_mcp_match.core.lgpd import opt_out as opt_out_mod
...
def test_postgres_repo_sql_template_has_only_placeholders() -> None:
    ...
    from brasil_mcp_match.core.repository import postgres_repo as repo_mod
